...
Бот работает на inline-кнопках. Все, что ниже называется командой подразумевает под собой наличие именно inline-кнопки. Все таблицы отрисовываются в подобном формате
